# PUBHLTH-5015-Final-Project
PubHlth 5015 Final Project Group: Brooke Bodine, Rosa Ferdelman, and Angela Wei

Instructions
Your README.md at the project root must contain:
<ul> 
  <li> A short project overview (what you analyse and why). </li>
  <li> A description of the data source(s) with links. </li>
...
docs/).</li>
  <li>If there are known limitations (e.g., large data downloads, long computation times), describe
them clearly. </li>
</ul>
